...
class IndigoPlant(Building):
    def __init__(self, colonists=0):
        Building.__init__(self,colonists=colonists,cost=3,points=2,capacity=3,size=1,name="lg_indigo")
...
class CoffeeRoaster(Building):
    def __init__(self, colonists=0):
        Building.__init__(self,colonists=colonists,cost=6,points=3,capacity=2,size=1,name="cof_roast")
